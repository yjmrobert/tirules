...
## Notes
 ...
 6. For notes about specific exploration cards, see the <a href="/components/c_exploration_cards">exploration cards notes page</a>.
 
 
## Related Topics

 
 - <a href="/rules/r_attach">Attach</a>
 - <a href="/rules/r_control">Control</a>
 - <a href="/rules/r_frontier_tokens">Frontier Tokens</a>
 - <a href="/rules/r_invasion">Invasion</a>
 - <a href="/rules/r_planets">Planets</a>
 - <a href="R_purge">Purge</a>
 - <a href="/rules/r_relics">Relics</a>
 - <a href="/rules/r_transactions">Transactions</a>
